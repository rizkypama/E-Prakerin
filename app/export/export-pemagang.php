        ...
        <div class="data-tables datatable-dark">
            ...
            <table id="mauexport" class="table table-hover">
                ...
                <tbody>
                    <?php
                    $no = 0;
                    $query = mysqli_query($koneksi, "SELECT tbp.id, tbp.nama, tbp.id_pembimbing, tbp.instansi, tbp.status, tbp.tglmulai, tbp.tglselesai, tbu.email FROM tb_pemagang as tbp, tb_users as tbu WHERE tbu.id = tbp.id_users AND tbp.id_pembimbing='{$_SESSION['id_pembimbing']}' AND tbp.status NOT IN ('Ditolak', 'Pending')");
