...
<body>
	...
	C4.622,10.623,2.833,8.831,2.845,6.631L2.845,6.631z" />
                ...
                <table id="example1">
                    ...
                    <tbody>
                        <?php
                        $no = 0;
                        $query = mysqli_query($koneksi, "SELECT tbp.id, tbp.nama, tbp.instansi, status FROM tb_pemagang as tbp WHERE status != 'Ditolak'");
    ...
    <script>
        document.getElementById('action-btn').addEventListener('click', function() {
            ...
            window.location.href = '../export/export-pemagang-all.php';
        });
    </script>
    <script>
