...
<body>
                        ...
                        ?>
                            <tr class="<?= $rowClass ?>">
                                ...
                                <td>
                                    <span class="original-text">
                                        <?php
                                        echo $row['deskripsi_kegiatan'];
                                        ?>
                                    </span>
                                    <span class="truncated-version">
                                        <?php
                                        $sentence = $row['deskripsi_kegiatan'];
                                        $split = substr($sentence, 0, 6) . '...';
                                        $words = str_word_count($sentence, 1);
                                ...
                                <td>
                                    <a href="detail_pengajuan-pemagang.php?id-pengajuan=<?= $row['id']; ?>&id-pemagang=<?= $row['id_pemagang'] ?>" class="btn btn-sm btn-outline-info">
    ...
    <script>
        window.addEventListener('DOMContentLoaded', () => {
            let text = document.getElementsByClassName('original-text').innerHTML;
            console.log(text);
            let truncated = text.substring(0, 5) + "...";
            document.getElementsByClassName("original-text").innerHTML = truncated;
        });
    </script>
</body>
