<div class="right-section">
    ...
    <div class="user-profile" id="settings">
        <div class="logo">
            <h2><?php echo $_SESSION['nama'] ?></h2>
            <p><?php echo $_SESSION['role_id'] ?></p>
        </div>
    </div>

    <div class="user-profile danger" id="update-status-button">
        <div class="logo">
            <p>Update Status Peserta</p>
        </div>
    </div>
        ...
        ?>
                <div class="notification">
                    ...
                    <div class="content">
                        ...
                        <a href="../delete/hapus_data.php?method=reminder_delete&id=<?php echo $reminder['id_pengingat']; ?>" class="delete-button">
        ...
        <div id="profileModal" class="profile-modal">
            <div class="modal-content">
                ...
                <form id="profileForm" action="../edit/edit_profil.php" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="text" id="jabatan" name="jabatan" value="<?php echo $_SESSION['jabatan']; ?>" required>
                    <label for="nip">NIP:</label>
                    <input type="text" id="nip" name="nip" value="<?php echo $_SESSION['nip']; ?>" required>
